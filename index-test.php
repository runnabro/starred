		...
		<footer class="small-entrance">
			<div>
				...
				--><div id="email" class="email-width">
					<a href="http://www.linkedin.com/pub/tony-li/40/26b/912" id="ln" target="_blank">
						<img src="img/social-icons.svg" height="50" width="80">
					</a>
					<a href="http://visual.ly/users/tli415?tab=submitted" id="ly" target="_blank">
						<img src="img/social-icons.svg" height="50" width="80">
					</a>
					<a href="mailto:tli415@gmail.com" id="em" target="_blank">tli415@gmail.com</a>
				</div><!--
				--><div class="ends"></div>
			</div>
		</footer>
