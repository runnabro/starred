		...
		<div id="wrapper">
			...
			<div id="gum" class="animate">
				<div id="wywh" class="each">
					<section>
						<div class="container">
							<figure class="monitor big-entrance out">
								<div>
									<img src="img/wywh/wywh-desktop.jpg" alt="">
									<div>
										<img src="img/wywh/wywh-desktop-2.png" alt="">
									</div>
									<a class="arrow"></a>
								</div>
							</figure>
					...
					<section id="responsive">
						<div class="container">
							<div class="tablet-container">
								...
								<img src="img/wywh/wywh-tablet.jpg" height="1250" width="480" alt="">
								<!--
								<div></div>-->
							...
							<div class="phone-container">
								...
								<img src="img/wywh/wywh-phone.jpg" height="917" width="176" alt="">
								<!--
								<div></div>-->
							</div><!--/.phone-container-->
						</div><!--/.container-->
					...
					<section id="contact">
						<div class="container">
							<div class="guides">
								<img src="img/wywh/wywh-guides.svg" class="guides" alt="">
							</div>
							<div class="figure">
								<figure>
									<div>
										<img src="img/wywh/loading.svg" height="60" width="60" alt="">
										<img src="img/wywh/wywh-thanks.png" height="100" width="400" alt="">
									</div>
								</figure>
								<img src="img/cursor.svg" class="cursor" height="20" width="20" alt="">
							</div>
						</div><!--/.container-->
					</section>
					<section id="legal-privacy">
						<div class="container">
							<div class="tablet-container">
								...
								<div>
									<div>
										<img src="img/wywh/wywh-legal-privacy-2.png" height="360" width="360" alt="">
									</div>
								</div>
								<img src="img/cursor.svg" class="cursor" height="20" width="20" alt="">
							</div><!--/.tablet-container-->
				...
				<div id="stylepro" class="each">
					<section>
						<div class="container">
							<figure class="monitor out">
								<div>
									<img src="img/stylepro/stylepro-1.jpg" alt="">
									<a class="arrow"></a>
								</div>
							</figure>
						</div><!--/.container-->
					...
					<section id="logo">
						<div class="container">
							<img src="img/stylepro/stylepro-4.svg" height="160" width="160" alt="">
						</div><!--/.container-->
					</section>
					<section id="additional">
						<div class="container">
							<figure class="browser">
								<div>
									<img src="img/stylepro/stylepro-2.jpg" height="523" width="458" alt="">
								</div>
							</figure>
							<figure class="browser">
								<div>
									<img src="img/stylepro/stylepro-3.jpg" height="523" width="458" alt="">
								</div>
							</figure>
						</div><!--/.container-->
					</section>
					...
					<section>
						<div class="container">
							<figure class="email sparrow out">
								<div>
									<img src="img/emailc/emailc-1.jpg" height="788" width="458" alt="">
									<a class="arrow"></a>
								</div>
							</figure>
							<figure class="email windows out">
								<div>
									<img src="img/emailc/emailc-2.jpg" height="640" width="458" alt="">
									<a class="arrow"></a>
								</div>
							</figure>
						</div><!--/.container-->
